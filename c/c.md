...
`SIGKILL` | Signal Kill | Cannot be caught or ignored, and is used to force a process to terminate immediately.
...
`SIGSTOP` | Signal Stop | Used to stop a process, and cannot be caught or ignored.
